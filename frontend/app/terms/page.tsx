      ...
      <main className="max-w-4xl mx-auto px-6 pt-40 pb-24">
        ...
        >
          ...
          <div className="space-y-4 border-b border-border-medium pb-12">
            <h1 className="text-5xl font-black text-foreground tracking-tight">Terms of Service</h1>
          ...
          <div className="prose prose-invert max-w-none space-y-10">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">3. AI-Generated Content</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">4. User Accounts</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">6. Limitations</h2>
              <p className="text-text-secondary leading-relaxed">
