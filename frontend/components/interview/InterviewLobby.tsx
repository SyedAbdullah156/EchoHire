    ...
    <div className="max-w-5xl mx-auto p-8 lg:p-12">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          <div className="relative aspect-video rounded-[3rem] overflow-hidden border border-border-medium bg-black shadow-2xl">
            ...
            <div className="absolute bottom-6 left-6 right-6 flex items-center gap-4">
              ...
              <FiMic className={micLevel > 5 ? "text-primary animate-pulse" : "text-foreground/40"} />
            </div>
          </div>
        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-4">
             <div className="p-6 rounded-3xl bg-surface-1 border border-border-subtle flex items-start gap-4">
                <div className="p-2 rounded-xl bg-primary/10 text-primary"><FiZap /></div>
                <div>
                   <h4 className="text-sm font-bold text-foreground mb-1">Adaptive Round</h4>
             ...
             <div className="p-6 rounded-3xl bg-surface-1 border border-border-subtle flex items-start gap-4">
                ...
                <div>
                   <h4 className="text-sm font-bold text-foreground mb-1">Stay Focused</h4>
          ...
          <button 
            onClick={onStart}
            disabled={!stream}
            className="w-full h-16 rounded-2xl bg-primary text-foreground font-black uppercase tracking-widest hover:bg-primary-hover transition-all active:scale-95 shadow-xl shadow-primary/20 disabled:opacity-50"
          >
            Start Interview Now
          </button>
        </div>
