          ...
          <section className="py-24 md:py-40 px-6">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-6">
                <Link
                  href="/auth"
                  className="w-full sm:w-auto min-h-[56px] px-10 py-4 bg-primary text-foreground font-bold rounded-2xl transition-all hover:bg-primary-hover active:scale-95 flex items-center justify-center gap-3 text-lg"
                >
                ...
                <Link
                  href="/pricing"
                  className="w-full sm:w-auto min-h-[56px] px-10 py-4 bg-surface-2 border border-border-medium text-foreground font-bold rounded-2xl transition-all hover:bg-surface-2 active:scale-95 flex items-center justify-center text-lg"
                >
                  View Pricing
                </Link>
              </div>
